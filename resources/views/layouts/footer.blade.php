    ...
    <div class="container mx-auto text-center text-gray-600">
        ...
        <div class="flex flex-col items-center space-y-2 md:space-y-0 md:flex-row md:justify-between md:space-x-2">
            ...
            <div class="flex items-center space-x-4">
                <a href="https://www.facebook.com/profile.php?id=100086392404380&mibextid=LQQJ4d" class="h-8 w-8 fill-current text-yellow-500 hover:text-yellow-400 rounded-full">
