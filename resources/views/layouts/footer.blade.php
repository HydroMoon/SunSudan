<footer class="bg-white py-4 shadow">
    <div class="container mx-auto text-center text-gray-600">
        <div class="flex flex-col space-y-2 md:space-y-0 md:grid md:grid-cols-2">
            <div class="flex flex-col space-y-2 md:space-y-0 md:grid md:grid-cols-3">
                ...
                <div class="flex flex-col md:items-start space-y-1">
                    ...
                    <a href="https://khartoum.aics.gov.it/en/home-eng/" target="_blank" class="text-gray-400 hover:text-gray-500 hover:underline">AICS</a>
                    <a href="https://www.wfp.org/countries/sudan" target="_blank" class="text-gray-400 hover:text-gray-500 hover:underline">WFP</a>
                    <a href="https://www.unicef.org/sudan/" target="_blank" class="text-gray-400 hover:text-gray-500 hover:underline">UNICEF</a>
                    <a href="https://www.emro.who.int/countries/sdn/index.html" target="_blank" class="text-gray-400 hover:text-gray-500 hover:underline">WHO</a>
                </div>
            </div>
            <div class="flex flex-col md:items-start space-y-1">
                <label class="text-gray-600">Scaling Up Nutrition Sudan</label>
                <p class="md:text-left mx-4 md:mx-0 text-gray-400">By 2030, a world free from malnutrition in all its forms. Led by governments, supported by organisations and individuals – collective action ensures every child, adolescent, mother and family can realise their right to food and nutrition, reach their full potential and shape sustainable and prosperous societies.</p>
                <br>
        ...
        <hr class="my-4">
        <div class="flex flex-col items-center space-y-2 md:space-y-0 md:flex-row md:justify-between md:space-x-2">
            <div class="flex items-center">
                <span class="text-gray-600">SunSudan.org © 2021 All rights reserved</span>
            </div>
            <div class="flex items-center space-x-4">
                <a href="https://www.facebook.com/profile.php?id=100086392404380&mibextid=LQQJ4d" target="_blank" class="h-8 w-8 fill-current text-yellow-500 hover:text-yellow-400 rounded-full">
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                    </svg>
                </a>
                <a href="#" class="h-8 w-8 fill-current text-yellow-500 hover:text-yellow-400 rounded-full">
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path
