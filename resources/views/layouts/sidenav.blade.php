<div class="container bg-white mx-auto h-full">
    <div class="flex flex-col h-full p-4 space-y-1">
        @if (Auth::check('web'))
            ...
            <a href="#"
                class="text-gray-500 hover:text-white hover:bg-yellow-400 px-4 py-2 rounded-md">Dashboard</a>
        ...
        @else
            ...
            <a href="{{ route('calendar') }}"
                class="text-gray-500 hover:text-white hover:bg-yellow-400 px-4 py-2 rounded-md">Calender</a>
            <a href="#" class="text-gray-500 hover:text-white hover:bg-yellow-400 px-4 py-2 rounded-md">Media</a>
